class DashboardController < ApplicationController
  ...
  def build_shortcut_groups
    ...
    fac << card("Proformas",         nil, "document-duplicate",       proformas_path,       :teal) if can_access?(:ventas)
    fac << card("Ventas",            nil, "currency-dollar",          facturas_path,          :teal) if can_access?(:ventas)
