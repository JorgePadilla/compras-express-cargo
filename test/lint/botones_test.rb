...
class BotonesTest < ActiveSupport::TestCase
  PRESUPUESTO = {
    ...
    "app/views/cuenta/pre_alertas/edit.html.erb"             => 5,
    ...
    "app/views/pre_alertas/edit.html.erb"                    => 4,
    ...
    "app/views/cuenta/pre_alertas/_move_modal.html.erb"      => 3,
    ...
    "app/views/pre_alertas/new.html.erb"                     => 3,
  ...
  BLANCO_SOBRE_TEAL = {
    ...
    "app/views/cuenta/pre_alertas/_move_modal.html.erb"    => 1,
