class CreateNotasDebito < ActiveRecord::Migration[8.0]
  def change
    create_table :notas_debito do |t|
    ...
    add_index :notas_debito, :numero, unique: true
    add_index :notas_debito, :estado
  end
end
